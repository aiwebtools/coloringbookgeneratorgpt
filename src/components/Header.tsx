      ...
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          <a href="/" className="flex items-center gap-2">
            ...
            <div>
              <h1 className="font-heading font-bold text-lg md:text-xl text-white">Coloring Book Generator</h1>
              <p className="text-xs text-gray-400 -mt-1">Presented by AiWebTools.Ai</p>
            </div>
          </a>
